...
PipelineStage = Literal["NEW", "APPROVED", "CONTACTED", "MEETING", "PROPOSAL", "CONTRACT_SIGNED", "CLOSED", "DISAPPROVED"]

VALID_COMPANY_TYPES: set[CompanyType] = {"CRE_OPERATOR", "COWORKING", "MULTI_TENANT", "OTHER"}
VALID_PIPELINE_STAGES: set[PipelineStage] = {"NEW", "APPROVED", "CONTACTED", "MEETING", "PROPOSAL", "CONTRACT_SIGNED", "CLOSED", "DISAPPROVED"}
